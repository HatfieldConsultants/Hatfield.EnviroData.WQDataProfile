...
namespace Hatfield.EnviroData.WQDataProfile
{
    public class StaticWQDefaultValueProvider : IWQDefaultValueProvider
    {
        ...
        public WayToHandleNewData WayToHandleNewData { get { return WayToHandleNewData.CreateInstanceForNewData; } }

        public bool SaveDefaultValueConfiguration(WQDefaultValueModel data) { return true; }
        public void Init() { }
    }
}
